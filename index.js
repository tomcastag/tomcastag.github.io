...
$("#trabajos").on("click", function() {
  $("#textoCentral").html("<p><strong>Pérdoname Señor! He sido Mala. De todo me arrepiento.</strong></p><p><a href='https://imgur.com/2olflKp'><img src='https://i.imgur.com/2olflKp.png' title='source: imgur.com' style='height: 100%; width: 100%; object-fit: contain'/></a></p><p>En escena: Catalina Lescano<br>Texto: Flavia Calise y Catalina Lescano<br>Dirección: Catalina Lescano<br>Colaboración Artística: Flavia Calise<br>Estreno Noviembre  2018. Ciclo Macriteatro Buenos Aires, Estudio Los Vidrios, CABA, Argentina.</p><p><i>Debajo del agua, ilumina y traiciona, ahora<br>La sangre que flota<br>¿acaso es mi boca que explotó en el río?<br>¿o un hombre desintegrado por mi lengua?</i></p><p>Poema confesional creado a partir de la filmografía de Armando Bó con Isabel Sarli entre los años 1958 y 1968.  Esta colaboración artística entre Catalina Lescano y Flavia Calise forma parte de una investigación sobre el imaginario erótico popular contemporáneo argentino.<br>Dirección General del proyecto: Catalina Lescano<br>Co-escritura: Flavia Calise y Catalina Lescano<br>Performance: Catalina Lescano</p>");
});
